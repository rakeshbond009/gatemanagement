...
// Get user details
$stmt = $conn->prepare("
    SELECT u.*, un.unit_number, un.block_number
    FROM users u
...
<head>
    ...
    <title>My Profile - Resident Panel</title>
...
<body>
    <div class="dashboard">
        ...
        <div class="main-content">
            <div class="header">
                <h1>My Profile</h1>
                <p>Block <?php echo htmlspecialchars($user['block_number']); ?> - Unit <?php echo htmlspecialchars($user['unit_number']); ?></p>
            </div>
